...
class ThoughtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thought" do
    assert_difference("Thought.count") do
      post thoughts_url, params: { thought: { content: @thought.content, mood: @thought.mood } }
    end
  ...
  test "should update thought" do
    patch thought_url(@thought), params: { thought: { content: @thought.content, mood: @thought.mood } }
